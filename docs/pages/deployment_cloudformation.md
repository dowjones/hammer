...
* **SourceIdentificationSQSEncryption**: the relative path to the Lambda package that identifies SQS unencrypted queues. The default value is **sqs-unencrypted-queues-identification.zip**.
