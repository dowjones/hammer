...
* **SourceIdentificationKMSKeyRotation**: the relative path to the Lambda package that identifies KMS key rotation issues. The default value is **kms-keyrotation-issues-identification.zip**.
