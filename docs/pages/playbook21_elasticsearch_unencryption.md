---
title: Elasticsearch unencrypted instances
keywords: playbook21
sidebar: mydoc_sidebar
permalink: playbook21_elasticsearch_unencryption.html
---

# Playbook 21: Elasticsearch unencrypted instances

## Introduction

This playbook describes how to configure Dow Jones Hammer to detect Elasticsearch domains that are not encrypted (either at dataatrest or node-node encryption).

## 1. Issue Identification

Dow Jones Hammer identifies those Elasticsearch domains for which ```StorageEncrypted``` parameter value is ```false```.
...
|Designation   |Path                  |
|--------------|:--------------------:|
|Initialization|`hammer/identification/lambdas/elasticsearch-unencrypted-domain-identification/initiate_to_desc_elasticsearch_unencrypted_domains.py`|
|Identification|`hammer/identification/lambdas/elasticsearch-unencrypted-domain-identification/describe_elasticsearch_unencrypted_domains.py`        |
...
```
hammer/reporting-remediation/reporting/create_elasticsearch_unencrypted_issue_tickets.py
```
