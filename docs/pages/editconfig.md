...
### 2.12. RDS Un-encrypted Instances

This section describes how to detect your un-encrypted RDS instances. Refer to [issue-specific playbook](playbook12_rds_unencryption.html) for further details.
