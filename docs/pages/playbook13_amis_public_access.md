...
|`topic_name`|Name of the SNS topic to trigger Lambda function from API scan.|`hammer-describe-ami-public-access-lambda`|
...
"public_ami_issues": {
        ...
        "topic_name": "hammer-describe-ami-public-access-lambda"
}
```
