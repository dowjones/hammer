resource "aws_cloudformation_stack" "identification" {
    ...
    depends_on = [
                  ...
                  "aws_s3_bucket_object.sqs-unencrypted-queues-identification"
                 ]
    ...
    parameters {
        ...
        SourceIdentificationSQSEncryption = "${aws_s3_bucket_object.sqs-unencrypted-queues-identification.id}"
    }
